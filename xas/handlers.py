...
class ISSXIAHDF5HandlerLegacy(Xspress3HDF5Handler, ISSHandlerBaseShiftRoot): # Denis: I used Xspress3HDF5Handler as basis since it has all the basic functionality and I more or less understand how it works
#    specs = {'PIL100k_HDF5'} | HandlerBase.specs
